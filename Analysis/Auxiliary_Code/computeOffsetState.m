function offsetState = computeOffsetState(runningBlocks,mod)
% For each mouse, this function computes the average of offset correlation
% maps across all legit running blocks. This returns a 92 x 92 matrix, 
% which is considered as the offset state.
% 
